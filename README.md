...
- Multi Tile Generator — visually arrange multiple map tiles before generating
...
## Requirements
- Blender **5.1** or newer (required for the bundled Python 3.13 geometry wheels)
...
`multitile_generator.html` (the Multi Tile Generator's frontend, a Premium-only feature) is excluded from this license — all rights reserved, no license is granted to copy, modify, or redistribute it.
